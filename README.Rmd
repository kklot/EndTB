...
- all the models are implemented in C++ which provides the fastest possible simulation.
- the models are called within TMB framework, the Template Model Builder,
allowing advanced and fast parameter estimation with emprical Bayes approach.
